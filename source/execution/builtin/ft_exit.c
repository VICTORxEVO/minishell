...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/22 11:45:36 by ysbai-jo          #+#    #+#             */
/*   Updated: 2024/12/22 11:45:37 by ysbai-jo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	if (cmd[1])
	{
		...
		while (cmd[1][++i])
		{
			if (!ft_isdigit((int)cmd[1][i]))
				return (pexit(ft_strjoin(ft_strjoin(": exit: ", cmd[1]),
							": argument must be a number"), 2, EXIT), 2);
		}
